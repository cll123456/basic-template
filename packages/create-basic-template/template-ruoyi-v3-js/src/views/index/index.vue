    ...
    <el-row>
      <el-col :span="16">
          ...
          <el-row :gutter="2">
            <el-col :span="8">
              <el-card shadow="hover">
                ...
                <div class="content">
                  基于SpringBoot，Spring Security，JWT，Vue & Element
                  的前后端分离权限管理系统。
                </div>
                <div class="footer">
                  <el-link :underline="false" href="http://doc.ruoyi.vip/"
                    >官 网</el-link
                  >
                  <el-link
                    :underline="false"
            ...
            <el-col :span="8">
              <el-card shadow="hover">
                ...
                <div class="content">
                  Elment 的升级版，原班人马重新为Vue3打造的企业级别UI框架。
                </div>
                <div class="footer">
                  <el-link
                    :underline="false"
            ...
            <el-col :span="8">
              <el-card shadow="hover">
                ...
                <div class="content">
                  Vue2的升级,script setup 函数的最终实践。
                </div>
                <div class="footer">
                  <el-link :underline="false" href="https://v3.cn.vuejs.org/"
                    >官 网</el-link
                  >
                  <el-link
                    :underline="false"
        ...
        <el-card class="box-card">
          ...
          <div class="content">
            <span style="font-weight: bold">RuoYi-Vue3-Js</span> 是以RuoYi
            中的spring-clound来作为后端。以Vue3.2.20， vite, vueuse,
            scss等来构建前端的。
            <p style="margin: 5px 0">
              项目高度还原了若依的功能，使用方式，总共实现了以下功能：拥有用户管理、部门管理、岗位管理、菜单管理、角色管理、字典管理、参数管理、通知公告、操作日志、登录日志等功能。
            </p>
            <address>
      ...
      <el-col :span="8" class="card-box" style="padding-right: 0px">
        ...
        <!-- gitup项目展示 -->
        <a
          class="img-pro--container"
          href="https://github.com/cll123456/rouyi-cloud-vue3"
        >
          <img
        ...
        <el-card class="box-card">
          ...
          <div class="content _flex">
            <div class="card-title person">
              <img
                src="https://avatars.githubusercontent.com/u/41314419?s=48&v=4"
              />
              <el-link
                type="primary"
                :underline="false"
